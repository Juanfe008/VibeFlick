<template>
    <div id="PostPage"
        ...
        <div class="lg:w-[calc(100%-540px)] h-full relative">
            ...
            <div v-if="true">
                <button :disabled="!isLoaded" @click="$event => loopThroughPostUp()"
                ...
                <button :disabled="!isLoaded" @click="$event => loopThroughPostDown()"
            ...
            <video v-if="true" class="absolute object-cover w-full my-auto z-[-1] h-screen" src="/video.mp4" />
            ...
            <div class="bg-black bg-opacity-70 lg:min-w-[480px]">
                <video v-if="true" ref="video" loop muted class="h-screen mx-auto" src="/video.mp4" />
            </div>
        </div>
        <div id="InfoSection" v-if="true" class="lg:max-w-[550px] relative w-full h-full bg-white">
            ...
            <div class="flex items-center justify-between px-8">
                <div class="flex items-center">
                    <NuxtLink>
                        <img class="rounded-full lg:mx-0 mx-auto" width="40" :src="defaultPP">
                    </NuxtLink>
            ...
            <div class="px-8 mt-4 text-sm">Post text</div>
                    ...
                    <div class="flex items-center relative w-full">
                        ...
                        <div class="ml-14 pt-0.5 w-full">
                            ...
                            <div class="text-[15px] font-light">
                                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Temporibus accusamus perspiciatis magni quidem provident nihil molestias eveniet nam quis dolorum ipsam tenetur mollitia ipsa at, dolorem adipisci voluptas reiciendis nesciunt?
                            </div>
                        </div>
                    </div>
                </div>
...
const { logos: { logoV3 }, defaultPP } = useNuxtApp().$paths;
