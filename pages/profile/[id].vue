  ...
  <MainLayout>
    <div class="pt-[90px] 2xl:pl-[185px] lg:pl-[160px] lg:pr-0 pr-2 w-[calc(100%-90px)] max-w-[1800px] 2xl:mx-auto">
        <div class="flex w-[calc(100vw-230px)]">
            <img 
                class="w-[120px] h-[120px] max-w-[120px] max-h-[120px] rounded-full"
                width="50" 
                :src="defaultPP"
            >
            <div class="ml-5 w-full">
                ...
                <div class="flex items-center">
                    <button
                        ...
                        class="flex item-center rounded-md py-1.5 px-3.5 mt-3 mr-3 text-[15px] font-semibold border hover:bg-gray-100"
                    >
                    ...
                    <button 
                        v-else
                        class="flex item-center rounded-md py-1.5 px-8 mt-3 text-[15px] text-white font-semibold bg-primary"
                    >
                        follow
                    </button>
                </div>
...
const { defaultPP } = useNuxtApp().$paths;
